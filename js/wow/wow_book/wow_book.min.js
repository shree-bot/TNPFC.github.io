...
(function(f) {
    ...
    H.prototype = {
        ...
        setDimensions: function(a, b) {
            ...
            if (this.clipBoundaries || this._restoreClipBoundaries) d = Math.ceil(Math.sqrt(this.pageWidth * this.pageWidth + this.pageHeight * this.pageHeight)), d = [this.pageHeight - d, c.width(), d, 0], this.origin.css("top", -d[0]), f(".wowbook-inner-clipper", c).css({
                width: "100%",
                height: d[2] - d[0],
                top: d[0]
            }), this.clipper.css({
